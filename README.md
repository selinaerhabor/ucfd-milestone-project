...
The User Centric Front-End Development (UCFD) Milestone project is to build a front-end only website for a 1960s Rock band. The Rock Band I have chosen is the English music group called The Kinks which was formed in Muswell Hill, London, UK in 1963.
...
## 2. Features
My project focused on meeting the needs of users’ for the website, so the user stories were taken into account during building the features and components of the website.
...
#### 6.1 Content:
##### About
The information for the biography of each member of the band has been collected from a range of sources in order to publish information about The Kinks which is true.
**Main sources**: [AllMusic], [Keno] and [Kastoffkinks]

##### Music
**Main sources**: The Kinks' Official [YouTube] and [itunes] accounts.

##### Photos
**Main sources**: The Kinks' Official [FaceBook] and [Twitter] accounts.

##### Events - Tours
**Main source**: [Ents24]

##### Store
**Main source**: [Official Merchandise Store]

##### Footer
The links to social media channels redirect users to The Kinks' Official Facebook, Twitter and YouTube accounts. The information in the Privacy Policy and Terms & Conditions links in the footer were tailored from [Sunny Afternoon The Musical] whilst the information in the Store Help link in the footer was tailored from [Sample Store].

#### 6.2 Media
The video used in the About section is available on YouTube:
https://www.youtube.com/embed/5FhaF0I3gv0

The photos used on this site were sourced from The Kinks' [Official Merchandise store] and their social media channels (see 6.3 Acknowledgements).

The audio clips of The Kinks' top tracks in the Music section were sourced from their Official [YouTube] channel and those YouTube videos were converted into mp3 files which have been included in the audio folder under assets.


#### 6.3 Acknowledgements
I received inspiration for this project from The Kinks’ Official Social Media channels: [YouTube], [Twitter] and [Facebook] and aimed to create a website that complements the content posted on these channels.
...
[Sample Store]: <https://www.samplestore.com/site/faq>
